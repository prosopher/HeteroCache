...
from heterocache_hs.train import (
    extract_past_key_values_and_top_hidden_states,
    load_translator_pool_from_checkpoint,
    restore_top_layer_past_from_hidden_states,
)
...
def run_eval(eval_config: EvalConfig) -> Path:
    ...
    logger.info("translation_mode=restore_kv_from_translated_hidden_states_then_replace_top_layers")
